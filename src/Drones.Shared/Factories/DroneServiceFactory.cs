...
namespace Drones.Shared
{
    public class DroneServiceFactory
    {
        ...
        {
            return ServiceProxy.Create<IDroneManagementService>(new Uri(DRONE_MANAGEMENT_URI), new ServicePartitionKey(0));
        }
        ...
        public async static Task<IDroneActor> GetDrone(string id)
        {
