    ...
    var Sound = (function () {
        ...
        */
            ...
            if (BABYLON.Engine.audioEngine.canUseWebAudio) {
                ...
                if (urlOrArrayBuffer) {
                    ...
                    if (typeof (urlOrArrayBuffer) === "string") {
                        ...
                        if (!this._streaming) {
                            Tools.LoadFile(urlOrArrayBuffer, function (data) { _this._soundLoaded(data); }, null, this._scene.database, true);
                        }
                        else {
        ...
        Sound.prototype._soundLoaded = function (audioData) {
            ...
            }, function () { Tools.Error("Error while decoding audio data for: " + _this.name); });
        };
